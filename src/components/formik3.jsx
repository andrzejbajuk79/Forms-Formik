...
const validationSchema = Yup.object({
 fullName: Yup.string()
  ...
  .min(2)
  .max(100),
 initialInvestmensts: Yup.number()
  .required()
  .min(1)
  .max(10),
        ...
        <FormGroup>
         ...
         <div>
          ...
          <div className="checkboxes">
           <MyCheckBox name="investmentsRisk" value="High" label="High" />
           <MyCheckBox name="investmentsRisk" value="Medium" label="Medium" />
           <MyCheckBox name="investmentsRisk" value="Low" label="Low" />
           <MyCheckBox
